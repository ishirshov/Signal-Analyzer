...
#ifndef IPP_FFT_INV_CCS2R_H
#define IPP_FFT_INV_CCS2R_H

#include <ipps.h>
#include <ippdefs.h>
#include <stdexcept>

/// \brief ipp_fft_inv_ccs2r    Provides a specialize interface for
///                             working with the inverse FFT function.
///
...
///
inline void ipp_fft_inv_ccs2r(const Ipp64f *pSrc, Ipp64f *pDst,
                              const IppsFFTSpec_R_64f *pSpec, Ipp8u *pBuffer)
{
    IppStatus message = ippsFFTInv_CCSToR_64f(pSrc, pDst, pSpec, pBuffer);
