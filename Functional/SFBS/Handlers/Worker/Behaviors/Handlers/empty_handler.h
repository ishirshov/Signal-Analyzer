...
#ifndef EMPTY_HANDLER_H
#define EMPTY_HANDLER_H

#include "handler_behavior.h"

class EmptyHandler : public HandlerBehavior
{
    Q_OBJECT

public:
    explicit EmptyHandler(QObject *parent = 0) { setParent(parent); }
